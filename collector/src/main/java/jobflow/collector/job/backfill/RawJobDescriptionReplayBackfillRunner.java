...
public class RawJobDescriptionReplayBackfillRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info(
                "Raw job description replay backfill completed. sources={}, processedCount={}, updatedDescriptionCount={}, unchangedDescriptionCount={}, skippedCount={}, failedCount={}, normalizedSkillJobCount={}, normalizedExperienceTagJobCount={}",
                sources,
