...
public enum ErrorCode {
    ...
    KAFKA_DLQ_INVALID_ENVELOPE(HttpStatus.BAD_REQUEST, "KAFKA_DLQ_INVALID_ENVELOPE", "DLQ envelope가 올바르지 않습니다."),
    KAFKA_DLQ_MESSAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "KAFKA_DLQ_MESSAGE_NOT_FOUND", "DLQ 메시지를 찾을 수 없습니다."),
    KAFKA_DLQ_MESSAGE_STATUS_CONFLICT(HttpStatus.CONFLICT, "KAFKA_DLQ_MESSAGE_STATUS_CONFLICT", "DLQ 메시지를 재처리할 수 없는 상태입니다."),
    KAFKA_DLQ_RETRY_FAILED(HttpStatus.BAD_GATEWAY, "KAFKA_DLQ_RETRY_FAILED", "DLQ 메시지 재처리에 실패했습니다."),
    ...
    AUTH_OAUTH2_PROVIDER_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH_OAUTH2_PROVIDER_TOKEN_NOT_FOUND", "저장된 OAuth2 provider token을 찾을 수 없습니다."),
