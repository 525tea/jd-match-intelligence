...
class JobFlowCachePropertiesTest {
    ...
    void usesDefaultTtlWhenPropertiesAreNull() {
        JobFlowCacheProperties properties = new JobFlowCacheProperties(true, null, null, null, null, null, null);

        assertThat(properties.jobSearchTtl()).isEqualTo(Duration.ofMinutes(5));
        ...
        assertThat(properties.recommendationTtl()).isEqualTo(Duration.ofMinutes(10));
    ...
    void usesConfiguredTtlWhenPropertiesAreProvided() {
        ...
        assertThat(properties.jobSearchTtl()).isEqualTo(Duration.ofMinutes(3));
        ...
        assertThat(properties.recommendationTtl()).isEqualTo(Duration.ofMinutes(5));
