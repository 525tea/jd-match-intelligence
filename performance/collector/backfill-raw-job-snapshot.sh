...
./gradlew bootRun \
  --args="--spring.profiles.active=${PROFILE} --spring.main.web-application-type=none --app.backfill.raw-job-snapshot.enabled=true --app.backfill.raw-job-snapshot.sources=${SOURCES}"
